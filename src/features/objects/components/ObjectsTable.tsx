    ...
    () => [
      ...
      },
      {
        ...
        cell: (info) => {
          ...
          if (!description) return <span className="text-gray-400 dark:text-slate-500">—</span>;
          const truncated = description.length > 50
            ? description.substring(0, 50) + '...'
            : description;
          return <span className="text-sm text-gray-600 dark:text-slate-400">{truncated}</span>;
        },
      },
      {
        id: 'actions',
